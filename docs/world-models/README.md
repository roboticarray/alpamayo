...
Generated 2026-09-17 from `*/scores.json` by `tools/build_index.py`. 27 repositories reviewed against [RUBRIC.md](RUBRIC.md). Scores are 1-5; Overall is the unweighted mean.
